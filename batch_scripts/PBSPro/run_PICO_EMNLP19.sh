...
# Output file
#PBS -o PICO_EMNLP19_output.log

# Error file
#PBS -e PICO_EMNLP19_err.log

# request resources and set limits
#PBS -l walltime=72:00:00
#PBS -l select=1:ncpus=24:mem=GB
#:ompthreads=24
...
#  run the script
python -u src/experiments/EMNLP2019/run_pico_experiments.py
python -u src/experiments/EMNLP2019/plot_pico_worker_models.py
