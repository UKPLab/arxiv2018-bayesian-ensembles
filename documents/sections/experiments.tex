...
% TODO: why the discrepancy between the latest results and some previous ones, e.g. DS, BSCC-Seq-IF with 
% same priors, BSCC-Vec-IF for NER? For BSCC, it may be due to different conf mat for the IF data model.
% TODO: re-run NER task 2 with BSCC-Seq.
% TODO: run DS and MACE with pico task 1.
...
DS & 77.02 & 71.79 & 74.31 & 75.17 & .9546 & 4.19 & \MULTIPLY{0.000604623040789}{82494}{\sol}\ROUND[0]{\sol}{\sol}\sol & &\\ % these are older results, not exactly sure why they're different.
%DS & 77.71 & 71.85 & 74.66 & 75.46 & .9551 & 4.10 & \MULTIPLY{0.000627877773126831}{82494}{\sol}\ROUND[0]{\sol}{\sol}\sol & &\\
...
HMM-Crowd & 77.67 & 70.05 & 73.67 & 75.33 & .9766 & 1.11 & 0 & Why better than BSCC-Vec-IF? & 0, 0.1 \\ % 10 EM iterations
HMM-Crowd-then-LSTM & 77.67 & 70.66 & 74.00 & 75.11 & .9058 & 13.92 & 0 & Are we sure we used right data? DS result was different & 0, .1\\  \hline
% some old stuff
...
% not quite as old stuff, but still pre-bugfix
...
%BSCC-Acc-IF & 81.25 & 47.19 & 59.71 & 61.05 & .9583 & 1.60 & 0 & Bad hyper-params? & 100, .1, .1 \\
BSCC-Acc-IF & 81.46 & 47.27 & 59.82 & 61.38 & .9592 & 1.61 & 0 & & .1, .1, .1 \\
%BSCC-MACE-IF & 60.32 & 76.17 & 67.33 & 68.04 & .9553 & 0.87 & 0 &  & 100, .1, 1\\
BSCC-MACE-IF & 67.72 & 75.04 & 71.20 & 70.90 & .9578 & 0.91 & 0 &  & .1, 1, .1\\
%BSCC-Vec-IF & 81.01 & 62.72 & 70.71 & 71.28 & .9695 & 0.82 & 0 &  & 10, 1 \\
BSCC-Vec-IF & 81.01 & 63.16 & 71.01 & 71.38 & .9702 & 0.80 & 0 &  &  .1, 1, .1\\
BSCC-IBCC-IF & 75.43 & 74.21 & 74.82 & 74.33 & .9733 & 0.55 & 0 &  & 100, .1, 9\\
%BSCC-Seq-IF & 81.66 & 69.49 & 75.08 & 71.31 & .9707 & 0.44 & 0 & & 100, 36\\ \hline
BSCC-Seq-IF & 81.88 & 70.66 & 75.86 & 73.94 & .9304 & 0.82 & 0 & & .1, 1, 1\\ \hline
BSCC-IBCC-IF-then-LSTM & 71.53 & 69.88 & 70.70 & 70.61 & .9082 & 16.92 & 0 & Pre bug-fix result & 50, 9 \\% Post bug-fix (with BSCC-seq), the LSTM seems to have failed - sometimes more epochs are required? Compare to HMM-Crowd-then-LSTM & 50, 9\\
...
%HMM-Crowd* & 72.81 & 75.14 & 73.93 & & & & & &\\  % from Nguyen -- different split
HMM-Crowd & 76.48 & 66.22 & 70.99 & 77.90 & .9435 & 0.79 & 0 & &\\ 
HMM-Crowd-then-LSTM &\\ \hline
%BSCC-Acc-NF & \\ % we should exclude these -- only include the best variants
%BSCC-MACE-NF & \\
%BSCC-Vec-NF & \\
BSCC-IBCC-NF & 61.83 & 76.33 & 68.32 & 74.80 & .9389 & 1.37 & 0 & &\\ \hline
%BSCC-Seq-NF & \\ \hline
%BSCC-Acc-IF & 89.53 & 45.11 & 59.99 & 74.76 & .9080 & 1.57 & 0 & & 100, 100, .1 \\
BSCC-Acc-IF & 89.58 & 45.14 & 60.04 & 74.95 & .9260 & 1.06 & 0 & & .1, .1, 10 \\
%BSCC-MACE-IF & 45.79 & 84.43 & 59.38 & 67.94 & .9441 & 2.01 & 0 & &  100, 100, .1\\
BSCC-MACE-IF & 46.68 & 84.36 & 60.10 & 68.51 & .9443 & 1.98 & 0 & &  .1, 100, .1\\
BSCC-Vec-IF & 77.22 & 64.86 & 70.51 & 77.41 & .9342 & 0.81 & 0 & & 100, 1, .1\\ % How about vec-to-seq? 
BSCC-IBCC-IF & 61.92 & 76.62 & 68.49 & 74.86 & .9387 & 1.37 & 0 & & 100, 100, 1 \\
%BSCC-Seq-IF & 78.37 & 62.78 & 69.71 & 38.95 & .9310 & 0.71 & 0 & Beats IBCC. Seq useful but too many params? & 100, .1, .1 \\ \hline
BSCC-Seq-IF & 86.39 & 61.97 & 72.17 & 52.64 & .9288 & .73 & 0 & & .1, .1, .1 \\ \hline 
BSCC-IBCC-IF-then-LSTM & 61.88 & 76.33 & 68.35 & 74.73 & .8868 & 19.69 & 0 & & .1, 100, .1 \\
% BSCC-Seq+LSTM &\\ % we already know that the other features help so leave them in
BSCC-IBCC-IF+LSTM & 61.15 & 76.56 & 67.99 & 74.90 & .9389 & 1.37 & 0 & & .1, 100, .1 \\
...
%BSCC-MACE-IF & \\
%BSCC-Vec-IF & \\
%BSCC-IBCC-IF & 0 & 0 & 0 & 18.17 & .8259 & 0.67 & 0 & Failed \\ \hline % most of the words don't have any training examples, so cannot be classified using only IF.
BSCC-IBCC-IF-then-LSTM & 57.67 & 66.04 & 61.57 & 33.60 & .8821 & 32.64 & 0 \\ % old results, pre-bugfix. The post-bugfix fun with BSCC-Seq seems to have failed to train. May need more epochs or automatic restarts/testing against dev.
BSCC-Seq-IF+LSTM & 51.51 & 3.79 & 7.06 & 12.61 & .8120 & 0.74 & 0 & Failed \\ % old results, but the new ones are basically the same.
BCC-Seq-IF+LSTM &\\
\hline
\end{tabularx}
