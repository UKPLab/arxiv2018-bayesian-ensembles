...
\subfloat[NER, random sampling]{
  \includegraphics[width=0.9\columnwidth, clip=True, trim=10 0 0 40]{figures/NER_RAND/pool/plot_f1-score-spans-strict}
}
\subfloat[NER, active learning simulation]{
  \includegraphics[width=0.9\columnwidth, clip=True, trim=10 0 0 40]{figures/NER_AL/pool/plot_f1-score-spans-strict}
}\\
\centering
\subfloat[PICO, random sampling]{
  \includegraphics[width=0.9\columnwidth, clip=True, trim=10 0 0 40]{figures/PICO_RAND/pool/plot_f1-score-spans-relaxed}
}
\subfloat[PICO, active learning simulation]{
  \includegraphics[width=0.9\columnwidth, clip=True, trim=10 0 0 40]{figures/PICO_AL/pool/plot_f1-score-spans-relaxed}
}
