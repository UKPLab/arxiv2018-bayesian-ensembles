...
DS & 77.52 & 71.68 & 74.49 & 75.35 & .9548 & 4.10 & \MULTIPLY{0.000651011392699372}{82494}{\sol}\ROUND[0]{\sol}{\sol}\sol & &\\ % these are older results, not exactly sure why they're different -- seems to have had slightly different dataset edits on apu and desktop-169. Now fixed and running with the original data...
...
%IBCC & 76.93 & 72.00 & 74.36 & 75.43 & .9592 & 0.62 & \MULTIPLY{0.000488269896998303}{82494}{\sol}\ROUND[0]{\sol}{\sol}\sol & & 100, 50, 1 \\ \hline
...
%BSCC-Vec-IF & 77.22 & 64.86 & 70.51 & 77.41 & .9342 & 0.81 & 0 & Without strong prior on IF & 100, 1, .1\\ % How about vec-to-seq? 
BSCC-Vec-IF & 74.90 & 67.18 & 70.83 & 76.95 & .9344 & 0.81 & 0 & Without strong prior on IF & .1, 1, .1\\ % How about vec-to-seq? 
