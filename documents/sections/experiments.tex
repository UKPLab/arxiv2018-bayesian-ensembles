...
25.5 & 100 & 1 & 1 \\
BSC-seq+LSTM & 
82.2 & \textbf{76.0} & \textbf{79.0} & 0.76 %79.6 & .9513 & % this requires 3 epochs then no changes to the model
...
13.5 \\
BSC-seq$\Arrow{0.2cm}$LSTM & 76.9 & 64.1 & \textbf{69.9} & %74.3 & \textbf{62.8} & \textbf{68.1} & %69.7 & .8868 & 
%15.65  
14.54 & 82.3 & \textbf{66.4} & \textbf{73.5} & %58.2 & .8349 &
 19.6  \\
BSC-seq+LSTM & 78.6 & 59.8 & 67.9 %72.3 & 64.2 & 68.0 &% 67.6 & .9589 &
% \textbf{0.6} 
& \textbf{0.55} & \textbf{87.4} & 57.9 & 69.7 & \textbf{0.9} \\%60.7 & 52.8 & 56.4 & 54.0 & \textbf{.899} & \textbf{0.48} & 0\\
%BCC-seq+LSTM &\\
