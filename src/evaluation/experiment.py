...
class Experiment(object):
    ...
    def __init__(self, generator, nclasses=None, nannotators=None, config=None, alpha0_factor=1.0, alpha0_diags=1.0,
                 beta0_factor=0.1, max_iter=20, crf_probs=False, rep=0, max_internal_iter=5, begin_factor=1.0):
    ...
    def _run_hmmcrowd(self, annotations, text, doc_start, outputdir, doc_subset, nselected_by_doc,
        ...
        hc = HMM_crowd(self.num_classes, nfeats, data, None, None, n_workers=annotations.shape[1],
                       vb=[self.nu0_factor, self.alpha0_factor], smooth=self.alpha0_factor)
