    ...
    for t in xrange(T):
        for l in xrange(L):
            for l_next in xrange(L):
                for k in xrange(K):
                    if doc_start[t]:
                        E_joint_t[t,-1,l_next] = alpha[t,l]*lnA[l,l_next]*lnPi[l,C[t,k],-1, k]*beta[t,l_next]
                    else:
                        E_joint_t[t,l,l_next] = alpha[t,l]*lnA[l,l_next]*lnPi[l,C[t,k],C[t-1,k], k]*beta[t,l_next]
