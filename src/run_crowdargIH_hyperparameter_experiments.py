'''
Tests different hyperparameter values with the crowdsourcing data. Currently only tests alpha0factor. It saves the
performance metrics as well as the lower bound.
