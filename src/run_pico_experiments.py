...
exp.methods = ['HMM_crowd_then_LSTM', 'majority', 'best', 'worst', 'ibcc', 'bac_mace', 'bac_acc', 'bac_seq', 'bac_ibcc']#, 'majority']#['mace', 'best', 'worst', 'majority']#'bac', 'ibcc', 'mace', 'majority'] # 'bac', 'clustering', 'ibcc', 'mace',
